...
export default function AppLayout({ children }) {
  ...
  // Check if the current page is one of our app tabs
  const isAppTab = tabs.some(tab => pathname === tab.href)
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Enhanced Bottom Navigation Bar - ONLY shows on actual app tabs */}
      {isAppTab && (
